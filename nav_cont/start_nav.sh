...
: "${CMD_VEL_SCAN_STOP_ENABLED:=true}"
: "${CMD_VEL_SCAN_TOPIC:=/scan_filtered}"
: "${CMD_VEL_FRONT_STOP_DISTANCE:=0.24}"
: "${CMD_VEL_REAR_STOP_DISTANCE:=0.20}"
: "${CMD_VEL_SCAN_HALF_ANGLE_DEG:=14.0}"
: "${CMD_VEL_SCAN_MIN_POINTS:=7}"
: "${CMD_VEL_MAP_STOP_ENABLED:=true}"
: "${CMD_VEL_MAP_TOPIC:=/map}"
: "${CMD_VEL_POSE_TOPIC:=/amcl_pose}"
: "${CMD_VEL_MAP_LOOKAHEAD_M:=0.20}"
: "${CMD_VEL_MAP_HALF_WIDTH_M:=0.08}"
...
: "${ROBOT_POSE_PUBLISH_RATE_HZ:=2.0}"
: "${ROBOT_POSE_LOOKUP_TIMEOUT_S:=0.2}"
: "${ENABLE_AMCL_POSE_PERSISTENCE:=1}"
