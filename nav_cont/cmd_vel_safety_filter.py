...
class CmdVelSafetyFilter(Node):
    def __init__(self):
        ...
        self.scan_min_points = self.declare_parameter("scan_min_points", 7).get_parameter_value().integer_value
        ...
        self.map_lookahead_m = self.declare_parameter("map_lookahead_m", 0.20).get_parameter_value().double_value
        self.map_half_width_m = self.declare_parameter("map_half_width_m", 0.08).get_parameter_value().double_value
